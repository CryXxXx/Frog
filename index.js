...
function place_coef() {
    ...
    fetch("https://9937bc55edcefb.lhr.life/get_last_game", {
...
*/
    ...
    if (usernameElement) {
        usernameElement.innerText = window.Telegram.WebApp.initDataUnsafe.user.first_name;
    } else {
...
function info(tg_id) {
    fetch('https://9937bc55edcefb.lhr.life/re_info', {
        method: 'POST',
        headers: {
