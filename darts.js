...
function info(tg_id) {
    fetch('https://9c92b003945821.lhr.life/re_info', {
        method: 'POST',
        headers: {
    ...
    if (betButtonSup.style.opacity === '1') {
        ...
        anime({
            ...
            complete: function() {
                ...
                fetch('https://9c92b003945821.lhr.life/darts', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
...
function handleServerResponse(result) {
    ...
    if (result.status === 'win') {
        ...
        // Обработка ситуации "нет денег" (остается без изменений)
    ...
    const newImageSrc = `assets/darts-apng-${randomValue}.png?timestamp=${Date.now()}`;
