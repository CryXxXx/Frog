...
// Обработчик ввода для amountInput
amountInput.addEventListener('input', (event) => {
    ...
    if (inputValue === '') {
        amountText.textContent = 'Enter Amount'; // Показываем текст при пустом поле
    } else {
        amountText.textContent = inputValue; // Обновляем текст с введенным значением
    }

    // Устанавливаем значение обратно в input
    amountInput.value = inputValue;
});

// Обработчик для установки текста при загрузке
